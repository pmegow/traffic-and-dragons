...
// static base.
//
// PRICE = VALUE (#303, owner ruling 2026-09-03): an item's worth is the AGGREGATE of its
// properties, never the party's purse. Base price for the plain type, then add: rare +10 gp,
...
var ITEM_BIBLE = {
  ...
  "leather armor": {
    ...
    "aliases": [],
    "effect": "Turns aside glancing cuts and grazes; a solid blow still lands. Quiet and light: no cost to stealth, climbing, or swimming.",
  ...
  "padded gambeson": {
    ...
    "aliases": [],
    "effect": "Quilted layers that soak bruising blows and blunt a cut; anything with weight behind it comes through. Hot and slow to dry, otherwise no cost.",
    "uses": "passive while worn",
    "value": "5 gp"
  },
  "chain shirt": {
    ...
    "aliases": [],
    "effect": "Rings over the torso turn most blades and arrows short of a heavy thrust; arms and legs stay bare. Rattles: a cost to stealth. Swimming in it is a fight.",
    "uses": "passive while worn",
    "value": "50 gp"
  },
  "brigandine": {
    ...
    "aliases": [],
    "effect": "Steel plates riveted under cloth: stops cuts outright and takes the worst out of crushing blows; a well-aimed thrust at a joint still finds skin. Heavy enough to tire on a long march; a cost to stealth and climbing.",
    "uses": "passive while worn",
    "value": "200 gp"
  },
  "plate harness": {
    ...
    "aliases": [],
    "effect": "Full steel: ordinary blades, arrows and clubs simply fail against it; only a heavy weapon, a joint, or magic gets through. Loud, exhausting, needs help to don; a hard cost to stealth, climbing and swimming, and a knight in it who falls in water drowns.",
    "uses": "passive while worn",
    "value": "1500 gp"
  },
  "healing salve": {
    ...
    "aliases": [],
    "effect": "Rubbed into a wound over a few minutes: stops bleeding and restores 1d4 HP. Common at any apothecary or herbalist; useless mid-fight.",
    "uses": "single use",
    "value": "8 gp"
  },
  "greater healing potion": {
    ...
    "aliases": [],
    "effect": "Drunk as an action: restores 4d4+4 HP and closes open wounds. Rare — an alchemist's work, not a market stall's.",
    "uses": "single use",
    "value": "150 gp"
  },
  "antitoxin": {
    ...
    "aliases": [],
    "effect": "Drunk as an action: ends one poison's ongoing effect and turns aside any new poison for the next hour.",
    "uses": "single use",
    "value": "25 gp"
  },
  "smelling salts": {
    ...
    "aliases": [],
    "effect": "Held under the nose: rouses an unconscious or stunned ally at once (not one at 0 HP). Enough for a handful of uses.",
    "uses": "3 uses",
    "value": "15 gp"
  }
};
