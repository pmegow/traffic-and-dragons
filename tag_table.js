...
{t:"LAYOUT",apply:function(text,R){var lts=text.match(/\[LAYOUT:([^\]]*)\]/g)||[],li;for(li=0;li<lts.length;li++){var lb=lts[li].slice(8,-1);var lr=(typeof fileLayout==="function")?fileLayout(lb,R.turn,"gm"):{ok:false,reason:"fileLayout missing"};
  ...
  R.muts.push("Layout: "+lr.rooms+" room"+(lr.rooms>1?"s":"")+" on record");}}},
