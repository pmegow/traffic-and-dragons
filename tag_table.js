...
{t:"SUBLOCATION_LEAVE",apply:function(text,R){var _lv=text.lastIndexOf("[SUBLOCATION_LEAVE]");if(_lv<0)return;var _ar=text.search(/\[SUBLOCATION:[^\]]+\]/),_arLast=-1,_m=text.match(/\[SUBLOCATION:[^\]]+\]/g);if(_m&&_m.length)_arLast=text.lastIndexOf(_m[_m.length-1]);if(_arLast>_lv)return;/* the arrival came after the leave — it stands */worldState.world.sublocation=null;R.muts.push("Left sub-location");}},
