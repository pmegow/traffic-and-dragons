...
{t:"LOCATION_ITEM",apply:function(text,R){__tagNearMiss(text,R,"LOCATION_ITEM","^\\[LOCATION_ITEM:[^|\\]]+\\|(placed|taken)(\\|[^|\\]]+)?\\]$","[LOCATION_ITEM:name|placed-or-taken]");var locItms=text.match(/\[LOCATION_ITEM:([^|\]]+)\|(placed|taken)(?:\|([^|\]]+))?\]/g)||[];var lii;for(lii=0;lii<locItms.length;lii++){var lip=locItms[lii].match(/\[LOCATION_ITEM:([^|\]]+)\|(placed|taken)(?:\|([^|\]]+))?\]/);if(!lip)continue;var _lnm=lip[1].trim(),_lact=lip[2],_lplace=lip[3]?lip[3].trim():null;
  ...
  var _lst=fileLocationItem(_lnm,_lact,R.turn,_lplace);
  ...
  R.muts.push((_lact==="placed"?"Left: ":"Taken: ")+_lnm+(_lst.qty>1?" ×"+_lst.qty:"")+(_lplace?" — at "+_lplace:""));}}},
