...
The room keeps one stable recording. UI refreshes and narration do not restart it. Fire fades in and ducks about 6 dB during a read, including its synthesis wait (v1.940, owner tuning 2026-09-15: 10 dB snapped back too starkly); finishing narration swells the level back over about four seconds. Leaving the room, closing time, switching campaigns, leaving gameplay, disabling ambience, or pausing releases playback. Microphone capture silences the gain synchronously before native recognition or cloud getUserMedia starts, and keeps it silent until capture ends.
