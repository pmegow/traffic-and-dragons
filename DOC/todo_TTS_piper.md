...
**Status:** Plan drafted 2026-07-15 by Opus 4.8, based on a validated spike. **Reviewed 2026-07-16 by Fable 5** — plan approved; all 7 open questions resolved with the user (§5); review findings folded into the phases (§4) and risks (§6). **Ready for implementation.**
