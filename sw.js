...
self.addEventListener("fetch", function(e){
  ...
  if(/blueprint-designer|todo-viewer|bible_study|bible_editor|piper_test|npc-merge-studio|bug_tracker|author_voice_lab|voice_picker|recall_gate|speaker_browser|libritts_speakers|vctk_speakers|timeline_day1|\/test\.html(?:$|[?#])|\/DOC\//.test(e.request.url)){/* class_bible left this regex at C6-② (2026-08-03): it precaches with the app shell now — keeping it network-first too would re-download it every load (the Netlify bandwidth class) */
    e.respondWith(
