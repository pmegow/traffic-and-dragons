...
function importSave(event){
  ...
  reader.onload=function(e){try{var data=JSON.parse(e.target.result);
    ...
    memory={attitudeSpec:mm.attitudeSpec,npcs:mm.npcs||{},locations:mm.locations||{},quests:mm.quests||{},lore:Array.isArray(mm.lore)?mm.lore:[],keyDecisions:Array.isArray(mm.keyDecisions)?mm.keyDecisions:[],futureEvents:Array.isArray(mm.futureEvents)?mm.futureEvents:[],chapters:Array.isArray(mm.chapters)?mm.chapters:[],eras:Array.isArray(mm.eras)?mm.eras:[],/* #168R (entry-13 review, brief D incidental): the whitelist silently dropped compiled eras on every .tnd import — the same class as the attitudeSpec and #144A drops above */map:mm.map||{nodes:{},edges:[],lastArrivalFrom:null},npcGraph:mm.npcGraph?{edges:mm.npcGraph.edges||[],factions:mm.npcGraph.factions||{},factionEdges:mm.npcGraph.factionEdges||[],npcFactions:mm.npcGraph.npcFactions||{}}:{edges:[],factions:{},factionEdges:[],npcFactions:{}},archive:mm.archive?{lore:mm.archive.lore||[],decisions:mm.archive.decisions||[],chapters:mm.archive.chapters||[],superseded:mm.archive.superseded||[],coreMemories:mm.archive.coreMemories||[],expiredSchedules:mm.archive.expiredSchedules||[],npcKnowledge:mm.archive.npcKnowledge||[],npcEvents:mm.archive.npcEvents||[],retconPins:mm.archive.retconPins||[],locationStates:mm.archive.locationStates||[],futureEvents:mm.archive.futureEvents||[],npcForgotten:mm.archive.npcForgotten||[],identityMerges:mm.archive.identityMerges||[],identityQuarantines:mm.archive.identityQuarantines||[]}:{lore:[],decisions:[],chapters:[]}};/* the FULL archive survives export/import (P12 + #144A) — the pre-#144A whitelist silently dropped superseded/coreMemories/expiredSchedules on every .tnd import (Sol's find, drift audit 2026-08-08) */
