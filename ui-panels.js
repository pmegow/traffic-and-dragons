...
function updateInvPanel(){
  ...
  if(typeof kindDef==="function"&&kindDef().waresPerShop&&typeof villageTradeContext==="function"&&typeof showShopModal==="function"){var _vtc=villageTradeContext();if(_vtc.ok)h+='<div class="ii" onclick="showShopModal()" style="cursor:pointer;color:var(--acc);font-size:11px;padding-top:6px;" title="Buy and sell at the counter">&#8646; Trade with '+escHtml(_vtc.keeper)+'</div>';}
  /* #6 E11: the chest — only in the hero's own house */
  if(typeof stashTradeCatalog==="function"&&typeof showStashModal==="function"&&stashTradeCatalog().ok)h+='<div class="ii" onclick="showStashModal()" style="cursor:pointer;color:var(--acc);font-size:11px;padding-top:6px;" title="Stow things in the house or take them with you">&#8645; Stow and take</div>';
