...
var ARCH_SPELLS={
  ...
  "arcanetrickster":{cantrips:["Mage Hand (invisible, 30ft)","Minor Illusion (sound or image, 30ft)","Message (whisper 120ft, target replies)"],1:["Charm Person (charmed 1 hour)","Silent Image (visual illusion)","Disguise Self (change appearance)"],2:["Invisibility (until attack or cast)","Shadow Blade (2d8 psychic weapon)"]}
};
...
var STAT_PRIORITY={"Warrior":["STR","CON","DEX","WIS","CHA","INT"],"Rogue":["DEX","INT","CHA","CON","WIS","STR"],"Sorcerer":["INT","DEX","CON","WIS","CHA","STR"],"Ranger":["DEX","WIS","CON","STR","INT","CHA"],"Berserker":["STR","CON","DEX","WIS","CHA","INT"],"Paladin":["CHA","STR","CON","WIS","DEX","INT"],"Cleric":["WIS","CON","STR","CHA","DEX","INT"],"Druid":["WIS","CON","DEX","INT","CHA","STR"]};
var DEFAULT_RULES=[
...
var NAMES={
  ...
  dwarf:["Aldun","Borunn","Carunn","Dorunn","Erdun","Fordin","Gorunn","Hardin","Igrun","Jordin","Khrunn","Lordin","Mordun","Nordin","Skorunn","Thorvik","Urgrun","Valdun","Beldun","Grimrun","Durvak","Helgrun","Irvunn","Korunn","Margrun"],
  gnome:["Alwick","Bilwick","Cogwhistle","Dazzwick","Elwick","Figwick","Grizwick","Hemwick","Inkwick","Jixwick","Krizwick","Nixwick","Pizwick","Quizzwick","Rizwick","Sizzwick","Trixwick","Wizzwick","Zippwick","Fumwick"],
  other:["Ash","Bale","Cinder","Dusk","Ember","Flint","Grim","Haze","Iron","Knox","Lash","Mire","Null","Onyx","Pitch","Quell","Ruin","Soot","Thorn","Vex","Cairn","Dirge","Fell","Ghast","Murk"]
};
