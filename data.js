...
var AUTHORS=[
  ...
  {id:"gaiman",nm:"Neil Gaiman",blurb:"Lyrical modern-fable; plain sentences that turn on one startling image.",vc:"Channel Neil Gaiman: plain, quietly precise sentences that turn on a single startling image. Mythic, fairy-tale cadence; state the uncanny as calmly as the mundane. Dry, understated wit. Let one small detail carry the weight. Restraint over flourish — never pile on adjectives."},
  {id:"abercrombie",nm:"Joe Abercrombie",blurb:"Grimdark, lean, brutal economy and dark wit.",profane:true,vc:"Channel Joe Abercrombie: lean, sharp, brutal economy. Short punchy sentences and the occasional deliberate fragment. Cynical, grounded interiority and dark humor. Violence lands hard in few words. Cut every wasted syllable."},
  {id:"dinniman",nm:"Matt Dinniman",blurb:"Dungeon Crawler Carl — irreverent, breakneck, game-native.",profane:true,vc:"Channel Matt Dinniman (Dungeon Crawler Carl): irreverent, breakneck, darkly funny. Treat the game's mechanics, stats, and absurd stakes as part of the voice. Snappy, modern, propulsive. Undercut danger with gallows humor."},
  {id:"clines",nm:"Peter Clines",blurb:"Clean contemporary thriller; maximum momentum, zero purple.",vc:"Channel Peter Clines: clean, transparent, propulsive thriller prose. Grounded everyman observation. Reveal the strange one piece at a time. Maximum momentum, zero purple — short sentences that pull the reader forward."},
  {id:"leguin",nm:"Ursula K. Le Guin",blurb:"Spare, mythic, elegant; weight through simplicity.",vc:"Channel Ursula K. Le Guin: spare, mythic, elegant. Weight through simplicity and restraint. Calm, measured rhythm; moral and cultural depth under a still surface. Say less; mean more."},
  {id:"howard",nm:"Robert E. Howard",blurb:"Conan — muscular, kinetic blood-and-thunder pulp.",vc:"Channel Robert E. Howard (Conan): muscular, kinetic, blood-and-thunder. Concrete violent verbs and sweeping momentum; vivid sensory action. But keep each sentence clean and singular — one strong image per sentence, never a pile of stacked clauses."},
  {id:"cook",nm:"Glen Cook",blurb:"The Black Company — terse, dry, soldier's-eye.",vc:"Channel Glen Cook (The Black Company): terse, dry, grounded soldier's-eye. Clipped and matter-of-fact, unromantic about horror and magic alike. Understated and laconic. Plain words, hard edges."},
  {id:"wells",nm:"Martha Wells",blurb:"Murderbot — dry, deadpan close interiority.",vc:"Channel Martha Wells (Murderbot): tight, close interiority with a dry, deadpan inner voice. Clean, economical sentences. Emotion through observation and understatement, not declaration. Wry, self-aware, never melodramatic."},
  {id:"muir",nm:"Tamsyn Muir",blurb:"The Locked Tomb — baroque gothic meets crude modern wit.",profane:true,vc:"Channel Tamsyn Muir (The Locked Tomb): baroque gothic imagery slammed against crude modern wit; gorgeous and irreverent in the same breath. Bold, swaggering voice. Hold the line on clarity — one vivid sentence at a time, never let the ornament collapse into a run-on."},
  {id:"abnett",nm:"Dan Abnett",blurb:"Gaunt's Ghosts — cinematic, disciplined military prose.",vc:"Channel Dan Abnett (Gaunt's Ghosts): cinematic, muscular military prose. Crisp action choreography, punchy short sentences for impact, vivid grimdark texture, a strong sense of scale. Controlled and propulsive — Howard's energy with discipline."}
];
var ANCS=[
