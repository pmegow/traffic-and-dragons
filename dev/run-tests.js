...
try {
  ...
  var _keysAC = ["lore", "decisions", "chapters", "superseded", "coreMemories", "expiredSchedules", "npcKnowledge", "npcEvents", "retconPins", "locationStates", "futureEvents", "npcForgotten", "identityMerges"];/* #156 Phase A: merge pre-images must survive .tnd round-trips */
