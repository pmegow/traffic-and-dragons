...
try {
  ...
  var _keysAC = ["lore", "decisions", "chapters", "superseded", "coreMemories", "expiredSchedules", "npcKnowledge", "npcEvents", "retconPins", "locationStates", "futureEvents", "npcForgotten"];
